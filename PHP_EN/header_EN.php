...
<nav id="navbar">
      ...
      <div class="wrapper">
        <ul>
          ...
          <li><a href="Hypotheekadvies_EN.php">Mortgage Advice</a></li>
          <li><a href="Hypotheekadvies_EN.php">2nd Opinion</a></li>
          <li><a href="Hypotheekadvies_EN.php">Mortgage Ready</a></li>
          <li><a href="Team_EN.php">Team</a></li>
          <li><a href="Contact_EN.php">Contact</a></li>
      
          <?php if(isset($_SESSION['auth'])):?>
            <li><a href="Logout_EN.php"> Logout</a></li>
          <?php else:?>
            <li><a href="Login_Menu_EN.php"> Login</a></li>
          <?php endif ?>
      ...
      <div class= "userLogo">
        <a href="Login_Menu_EN.php"> <img src="../images/LoginLogo.svg" alt="User Logo" style="width:250%;height:250%"></a>
      </div>
      ...
      <div class="switch">
        ...
        <div class="span-left"  id="span-left" style="left:-100%;">
          <?php include("mijn_hypotheek_EN.php"); ?>
        </div>
      
        <div class="span-right" id="span-right" style="left:100%;" >
          <?php include("Persoonsgegevens_EN.php"); ?>
        </div>
